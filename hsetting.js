...
var trans = "<p1 style='color: transparent'>_________</p1>"

var trans1 = "<p1 style='color: transparent'>______________</p1>"

var trans2 = "<p1 style='color: transparent'>_____________________</p1>"

var trans3 = "<p1 style='color: transparent'>___________________</p1>"

var ln =  "_______________________________________________________________________________________________________" ;
...
var cond1 = sk + trans + " " + offs + trans + inst + trans + pol + trans + cho + "<br>" + ln + "<br>" + ch_bcc + trans + "<br>" + ln + "<br>" + skd + trans + deg1 + "." + min1 + "." + sec1 + trans1 + degi1 + "." + mini1 + "." + seci1 + trans2 + pola1 + trans3 + choord1 + "<br>"  + ln + "<br>" + ch_ecc + trans + dega1 + "." + mina1 + "." + seca1 + trans1 + degii1 + "." + minii1 + "." + secii1 + trans2 + polai1 + trans3 + choordi1 + "<br>";

var cond2 = sk + trans + " " + offs + trans + inst + trans + pol + trans + cho + "<br>" + ln + "<br>" + ch_bcc + trans + "<br>" + ln + "<br>" + skd + trans + deg1 + "." + min1 + "." + sec1 + trans1 + degi1 + "." + mini1 + "." + seci1 + trans3 + pola1 + trans3 + choord1 + "<br>"  + ln + "<br>" + skd1 + trans + deg2 + "." + min2 + "." + sec2 + trans1 + degi2 + "." + mini2 + "." + seci2 + trans2 + pola2 + trans3 + choord2 + "<br>"  + ln + "<br>" + ch_ecc + trans + dega2 + "." + mina2 + "." + seca2 + trans1 + degii2 + "." + minii2 + "." + secii2 + trans2 + polai2 + trans3 + choordi2 + "<br>";

var cond3 = sk + trans + " " + offs + trans + inst + trans + pol + trans + cho + "<br>" + ln + "<br>" + ch_bcc + trans + "<br>" + ln + "<br>" + skd + trans + deg1 + "." + min1 + "." + sec1 + trans1 + degi1 + "." + mini1 + "." + seci1 + trans3 + pola1 + trans3 + choord1 + "<br>"  + ln + "<br>" + skd1 + trans + deg2 + "." + min2 + "." + sec2 + trans1 + degi2 + "." + mini2 + "." + seci2 + trans2 + pola2 + trans3 + choord2 + "<br>" + ln + "<br>" + skd2 + trans + deg2 + "." + min2 + "." + sec2 + trans1 + degi3 + "." + mini3 + "." + seci3 + trans2 + pola3 + trans3 + choord3 + "<br>"  + ln + "<br>" + ch_ecc + trans + dega3 + "." + mina3 + "." + seca3 + trans1 + degii3 + "." + minii3 + "." + secii3 + trans2 + polai3 + trans3 + choordi3 + "<br>";

var cond4 = sk + trans + " " + offs + trans + inst + trans + pol + trans + cho + "<br>" + ln + "<br>" + ch_bcc + trans + "<br>" + ln + "<br>" + skd + trans + deg1 + "." + min1 + "." + sec1 + trans1 + degi1 + "." + mini1 + "." + seci1 + trans3 + pola1 + trans3 + choord1 + "<br>"  + ln + "<br>" + skd1 + trans + deg2 + "." + min2 + "." + sec2 + trans1 + degi2 + "." + mini2 + "." + seci2 + trans2 + pola2 + trans3 + choord2 + "<br>" + ln + "<br>" + skd2 + trans + deg2 + "." + min2 + "." + sec2 + trans1 + degi3 + "." + mini3 + "." + seci3 + trans2 + pola3 + trans3 + choord3 + "<br>"  + ln + "<br>" + skd3 + trans + deg2 + "." + min2 + "." + sec2 + trans1 + degi4 + "." + mini4 + "." + seci4 + trans2 + pola4 + trans3 + choord4 + "<br>"  + ln + "<br>" + ch_ecc + trans + dega4 + "." + mina4 + "." + seca4 + trans1 + degii4 + "." + minii4 + "." + secii4 + trans2 + polai4 + trans3 + choordi4 + "<br>";

var cond5 = sk + trans + " " + offs + trans + inst + trans + pol + trans + cho + "<br>" + ln + "<br>" + ch_bcc + trans + "<br>" + ln + "<br>" + skd + trans + deg1 + "." + min1 + "." + sec1 + trans1 + degi1 + "." + mini1 + "." + seci1 + trans3 + pola1 + trans3 + choord1 + "<br>"  + ln + "<br>" + skd1 + trans + deg2 + "." + min2 + "." + sec2 + trans1 + degi2 + "." + mini2 + "." + seci2 + trans2 + pola2 + trans3 + choord2 + "<br>" + ln + "<br>" + skd2 + trans + deg2 + "." + min2 + "." + sec2 + trans1 + degi3 + "." + mini3 + "." + seci3 + trans2 + pola3 + trans3 + choord3 + "<br>"  + ln + "<br>" + skd3 + trans + deg2 + "." + min2 + "." + sec2 + trans1 + degi4 + "." + mini4 + "." + seci4 + trans2 + pola4 + trans3 + choord4 + "<br>"  + ln + "<br>" + skd4 + trans + deg2 + "." + min2 + "." + sec2 + trans1 + degi5 + "." + mini5 + "." + seci5 + trans2 + pola5 + trans3 + choord5 + "<br>"  + ln + "<br>" + ch_ecc + trans + dega5 + "." + mina5 + "." + seca5 + trans1 + degii5 + "." + minii5 + "." + secii5 + trans2 + polai5 + trans3 + choordi5 + "<br>";

var cond6 = sk + trans + " " + offs + trans + inst + trans + pol + trans + cho + "<br>" + ln + "<br>" + ch_bcc + trans + "<br>" + ln + "<br>" + skd + trans + deg1 + "." + min1 + "." + sec1 + trans1 + degi1 + "." + mini1 + "." + seci1 + trans3 + pola1 + trans3 + choord1 + "<br>"  + ln + "<br>" + skd1 + trans + deg2 + "." + min2 + "." + sec2 + trans1 + degi2 + "." + mini2 + "." + seci2 + trans2 + pola2 + trans3 + choord2 + "<br>" + ln + "<br>" + skd2 + trans + deg2 + "." + min2 + "." + sec2 + trans1 + degi3 + "." + mini3 + "." + seci3 + trans2 + pola3 + trans3 + choord3 + "<br>"  + ln + "<br>" + skd3 + trans + deg2 + "." + min2 + "." + sec2 + trans1 + degi4 + "." + mini4 + "." + seci4 + trans2 + pola4 + trans3 + choord4 + "<br>"  + ln + "<br>" + skd4 + trans + deg2 + "." + min2 + "." + sec2 + trans1 + degi5 + "." + mini5 + "." + seci5 + trans2 + pola5 + trans3 + choord5 + "<br>"  + ln + "<br>" + skd5 + trans + deg2 + "." + min2 + "." + sec2 + trans1 + degi6 + "." + mini6 + "." + seci6 + trans2 + pola6 + trans3 + choord6 + "<br>"  + ln + "<br>" + ch_ecc + trans + dega6 + "." + mina6 + "." + seca6 + trans1 + degii6 + "." + minii6 + "." + secii6 + trans2 + polai6 + trans3 + choordi6 + "<br>";

var cond7 = sk + trans + " " + offs + trans + inst + trans + pol + trans + cho + "<br>" + ln + "<br>" + ch_bcc + trans + "<br>" + ln + "<br>" + skd + trans + deg1 + "." + min1 + "." + sec1 + trans1 + degi1 + "." + mini1 + "." + seci1 + trans3 + pola1 + trans3 + choord1 + "<br>"  + ln + "<br>" + skd1 + trans + deg2 + "." + min2 + "." + sec2 + trans1 + degi2 + "." + mini2 + "." + seci2 + trans2 + pola2 + trans3 + choord2 + "<br>" + ln + "<br>" + skd2 + trans + deg2 + "." + min2 + "." + sec2 + trans1 + degi3 + "." + mini3 + "." + seci3 + trans2 + pola3 + trans3 + choord3 + "<br>"  + ln + "<br>" + skd3 + trans + deg2 + "." + min2 + "." + sec2 + trans1 + degi4 + "." + mini4 + "." + seci4 + trans2 + pola4 + trans3 + choord4 + "<br>"  + ln + "<br>" + skd4 + trans + deg2 + "." + min2 + "." + sec2 + trans1 + degi5 + "." + mini5 + "." + seci5 + trans2 + pola5 + trans3 + choord5 + "<br>"  + ln + "<br>" + skd5 + trans + deg2 + "." + min2 + "." + sec2 + trans1 + degi6 + "." + mini6 + "." + seci6 + trans2 + pola6 + trans3 + choord6 + "<br>"  + ln + "<br>" + skd6 + trans + deg2 + "." + min2 + "." + sec2 + trans1 + degi7 + "." + mini7 + "." + seci7 + trans2 + pola7 + trans3 + choord7 + "<br>"  + ln + "<br>" + ch_ecc + trans + dega7 + "." + mina7 + "." + seca7 + trans1 + degii7 + "." + minii7 + "." + secii7 + trans2 + polai7 + trans3 + choordi7 + "<br>";

var cond8 = sk + trans + " " + offs + trans + inst + trans + pol + trans + cho + "<br>" + ln + "<br>" + ch_bcc + trans + "<br>" + ln + "<br>" + skd + trans + deg1 + "." + min1 + "." + sec1 + trans1 + degi1 + "." + mini1 + "." + seci1 + trans3 + pola1 + trans3 + choord1 + "<br>"  + ln + "<br>" + skd1 + trans + deg2 + "." + min2 + "." + sec2 + trans1 + degi2 + "." + mini2 + "." + seci2 + trans2 + pola2 + trans3 + choord2 + "<br>" + ln + "<br>" + skd2 + trans + deg2 + "." + min2 + "." + sec2 + trans1 + degi3 + "." + mini3 + "." + seci3 + trans2 + pola3 + trans3 + choord3 + "<br>"  + ln + "<br>" + skd3 + trans + deg2 + "." + min2 + "." + sec2 + trans1 + degi4 + "." + mini4 + "." + seci4 + trans2 + pola4 + trans3 + choord4 + "<br>"  + ln + "<br>" + skd4 + trans + deg2 + "." + min2 + "." + sec2 + trans1 + degi5 + "." + mini5 + "." + seci5 + trans2 + pola5 + trans3 + choord5 + "<br>"  + ln + "<br>" + skd5 + trans + deg2 + "." + min2 + "." + sec2 + trans1 + degi6 + "." + mini6 + "." + seci6 + trans2 + pola6 + trans3 + choord6 + "<br>"  + ln + "<br>" + skd6 + trans + deg2 + "." + min2 + "." + sec2 + trans1 + degi7 + "." + mini7 + "." + seci7 + trans2 + pola7 + trans3 + choord7 + "<br>"  + ln + "<br>" + skd7 + trans + deg2 + "." + min2 + "." + sec2 + trans1 + degi8 + "." + mini8 + "." + seci8 + trans2 + pola8 + trans3 + choord8 + "<br>"  + ln + "<br>" + ch_ecc + trans + dega8 + "." + mina8 + "." + seca8 + trans1 + degii8 + "." + minii8 + "." + secii8 + trans2 + polai8 + trans3 + choordi8 + "<br>";

var cond9 = sk + trans + " " + offs + trans + inst + trans + pol + trans + cho + "<br>" + ln + "<br>" + ch_bcc + trans + "<br>" + ln + "<br>" + skd + trans + deg1 + "." + min1 + "." + sec1 + trans1 + degi1 + "." + mini1 + "." + seci1 + trans3 + pola1 + trans3 + choord1 + "<br>"  + ln + "<br>" + skd1 + trans + deg2 + "." + min2 + "." + sec2 + trans1 + degi2 + "." + mini2 + "." + seci2 + trans2 + pola2 + trans3 + choord2 + "<br>" + ln + "<br>" + skd2 + trans + deg2 + "." + min2 + "." + sec2 + trans1 + degi3 + "." + mini3 + "." + seci3 + trans2 + pola3 + trans3 + choord3 + "<br>"  + ln + "<br>" + skd3 + trans + deg2 + "." + min2 + "." + sec2 + trans1 + degi4 + "." + mini4 + "." + seci4 + trans2 + pola4 + trans3 + choord4 + "<br>"  + ln + "<br>" + skd4 + trans + deg2 + "." + min2 + "." + sec2 + trans1 + degi5 + "." + mini5 + "." + seci5 + trans2 + pola5 + trans3 + choord5 + "<br>"  + ln + "<br>" + skd5 + trans + deg2 + "." + min2 + "." + sec2 + trans1 + degi6 + "." + mini6 + "." + seci6 + trans2 + pola6 + trans3 + choord6 + "<br>"  + ln + "<br>" + skd6 + trans + deg2 + "." + min2 + "." + sec2 + trans1 + degi7 + "." + mini7 + "." + seci7 + trans2 + pola7 + trans3 + choord7 + "<br>"  + ln + "<br>" + skd7 + trans + deg2 + "." + min2 + "." + sec2 + trans1 + degi8 + "." + mini8 + "." + seci8 + trans2 + pola8 + trans3 + choord8 + "<br>"  + ln + "<br>" + skd8 + trans + deg2 + "." + min2 + "." + sec2 + trans1 + degi9 + "." + mini9 + "." + seci9 + trans2 + pola9 + trans3 + choord9;

if (R == "" || I == "" || ch_bcc == "" || peg_int == "" || ori == "" || skd == "") {

document.getElementById("ds").innerHTML = "Please insert in all input Fields!";

}else if (arc_l < 40 || arc_l == 40) {

document.getElementById("ds").innerHTML = cond1;

}else if (arc_l > 40 && arc_l < 60 || arc_l == 60) {

document.getElementById("ds").innerHTML = cond2;

}else if (arc_l > 60 && arc_l < 80 || arc_l == 80) {

document.getElementById("ds").innerHTML = cond3;

}else if (arc_l > 80 && arc_l < 100 || arc_l == 100) {

document.getElementById("ds").innerHTML = cond4;

}else if (arc_l > 100 && arc_l < 120 || arc_l == 120) {

document.getElementById("ds").innerHTML = cond5;

}else if (arc_l > 120 && arc_l < 140 || arc_l == 140) {

document.getElementById("ds").innerHTML = cond6;

}else if (arc_l > 140 && arc_l < 160 || arc_l == 160) {

document.getElementById("ds").innerHTML = cond7;

}else if (arc_l > 160 && arc_l < 180 || arc_l == 180) {

document.getElementById("ds").innerHTML = cond8;

}else

document.getElementById("ds").innerHTML = "Arc Length is too big!";
